...
#' @param s0 Variance of the initial condition. Mean of the initial condition is set to 0.
#' @param delta Variance of the innovation.
...
#' @param sigma Variance of the emission equation.
