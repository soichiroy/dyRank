...
dyRank_gibbs <- function(dat, race_attr, driver_attr, id_driver_fix, lambda, c_mk, trunc) {
    invisible(.Call(`_dyRank_dyRank_gibbs`, dat, race_attr, driver_attr, id_driver_fix, lambda, c_mk, trunc))
}

dyRank_cpp <- function(dat, race_attr, driver_attr, lambda, c_mk, mcmc, burnin, thin, id_driver_fix, trunc) {
    .Call(`_dyRank_dyRank_cpp`, dat, race_attr, driver_attr, lambda, c_mk, mcmc, burnin, thin, id_driver_fix, trunc)
}
